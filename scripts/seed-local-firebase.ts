...
async function main(): Promise<void> {
  ...
  const { AllPermissions, Permission } = await import(
    "@/domain/enums/Permission"
  );
  const { ChurchFirebaseRepository } = await import(
    "@/infra/firebase-admin/repositories/ChurchFirebaseRepository"
  );
  const { MinistryFirebaseRepository } = await import(
    "@/infra/firebase-admin/repositories/MinistryFirebaseRepository"
  );
  const { RoleFirebaseRepository } = await import(
    "@/infra/firebase-admin/repositories/RoleFirebaseRepository"
  );
  const { RolePermissionFirebaseRepository } = await import(
    "@/infra/firebase-admin/repositories/RolePermissionFirebaseRepository"
  );
