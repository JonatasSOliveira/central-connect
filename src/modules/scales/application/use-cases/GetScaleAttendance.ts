...
import type { ScaleAttendanceDetailDTO } from "@/modules/scales/application/dtos/ScaleAttendanceDTO";
import { ScaleAttendanceErrors } from "@/modules/scales/application/errors/ScaleAttendanceErrors";
  ...
  async execute(
    ...
    try {
      ...
      const [scaleMembers, attendance, service] = await Promise.all([
        ...
        this.scaleAttendanceRepository
          .findByScaleId(scale.id)
          .catch(() => null),
