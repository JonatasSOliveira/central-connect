      ...
      <div className="space-y-3">
        ...
        {churchId && (
          <CardItem
            ...
            description="Visualize ou edite a igreja atual"
            icon={Building2}
        ...
        <CardItem
          title="Notificações"
          description="Gerencie seus alertas do aplicativo"
          icon={Bell}
        ...
        {user?.churches && user.churches.length > 1 && (
          <CardItem
            ...
            description="Altere o contexto da igreja atual"
            icon={Building2}
      ...
      <AlertDialog open={showLogout} onOpenChange={setShowLogout}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Você poderá entrar novamente com sua conta Google.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
